...
cargo test                      # 327 tests across 3 crates (19 ignored: full-physics, require ANISE kernels)
```
...
rpo-api/src/              → docs/API.md
  ...
  handlers/     classify, transfer, plan, move_waypoint, update_config, extract_drag, validate, mc
```
